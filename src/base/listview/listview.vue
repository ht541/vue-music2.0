  ...
  methods:{
    selectItem(item){
     ...
     onShortcutTouchStart(e){
           let anchortIndex = getData(e.target,'index')
           let firstTouch = e.touches[0]
           this.touch.y1 = firstTouch.pageY
           this.touch.anchortIndex = anchortIndex
           this._scrollTo(anchortIndex)
     },
     onShortcutTouchMove(e){ 
           let firstTouch = e.touches[0]
           this.touch.y2 = firstTouch.pageY
           let delta = (this.touch.y2 - this.touch.y1) / ANCHOR_HEIGHT | 0
           let anchortIndex = parseInt(this.touch.anchortIndex) +delta
           this._scrollTo(anchortIndex)
     },

     refrech(){
       this.$refs.listview.refrech()
     },
